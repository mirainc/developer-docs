...
When users configure your app via it’s [inputs](/docs/core-concepts/inputs), we call that a _presentation._ Presentations are assigned durations, added to playlists and then published to devices.
...
- [How to hook into the app lifecycle with the Raydiant SDK](/docs/raydiant-sdk)
