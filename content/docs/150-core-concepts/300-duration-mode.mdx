...
Displai apps support two different duration modes; _fixed_ and _dynamic_. 
...
Since the runtime is able to determine the duration of the app before loading it—the Weather app's duration mode is _fixed_. 
...
Since the runtime is unable to determine the duration of a dynamic duration app, you must use the [Displai SDK](/docs/displai-sdk) to notify the runtime when your app has completed.
...
- [Learn how to use the Displai SDK's runtime API](/docs/displai-sdk/runtime)
