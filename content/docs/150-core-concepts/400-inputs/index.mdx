...
excerpt: Customize your app in the Displai Dashboard.
collapsible: true
collapsed: true
---

Inputs allow users to customize your app in the Displai Dashboard, for example:
...
When users customize your app in the Displai Dashboard the input values are injected into the URL template to render the resulting URL:
...
Displai supports a variety of input types you can use to customize your app. Check out the [Build an App](/docs/get-started/build-an-app) tutorial for an in-depth walkthrough on how to add inputs.
