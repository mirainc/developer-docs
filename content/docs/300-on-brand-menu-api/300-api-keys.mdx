...
<Callout>**Single API Key vs Many API Keys: Although it's possible to create a unique API Key for each of your locations and menus, creating just a single API Key for all locations and menus simplifies API Key management and takes the guess-work out of remembering which key goes with which menus and locations.** </Callout>
