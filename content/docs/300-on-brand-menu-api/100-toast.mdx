...
2. Select “API Source” [TODO: source icon].
...
11. Click the settings icon [TODO: settings icon] next to the Raydiant integration from the [My Integrations](https://www.toasttab.com/restaurants/admin/integrations/my-integrations) page.
12. Paste the location ID from step 5 into the Location ID field and click “Apply”

    <img
      src="/add-raydiant-to-toast.png"
...
14. Wait 10-15 seconds, if setup correctly you will see your new source successfully connect to your Toast location.
    ...
    <img src="/linked-source.png" alt="Linked source" />

<Callout>
  **Known issue**: After successfully connecting a new Toast source you will
...
Only size-based modifiers will be returned from the On-Brand Menu API.

<Callout>The On-Brand Menu API does not currently support groups of sub-items. Toastmodifier groups will be flattened into a single list of sub-items.</Callout>
