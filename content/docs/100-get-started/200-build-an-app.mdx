...
This tutorial will walk you through the basics of building a Displai app. We’ll use the [Weather](https://simple-weather-app.displai.ai/?location=New%20York) app to set up its inputs and preview the app in the Displai Dashboard.
...
Before you can create your first app you will need to [create an account](/docs/get-started/create-an-account) to access the Developer Portal and the Displai Dashboard.

Once you have an account, sign in to the [Developer Portal](https://developers.displai.ai) to begin the tutorial.

## 2. Create the App

From the [Apps](https://developers.displai.ai/apps) section, we’ll start by creating the Weather app and adding an icon and thumbnail.

1. Click the “Create app” button <DisplaiIcon name="add" />.
...
```bash
 https://simple-weather-app.displai.ai?location=:location&units=:units
```
...
2. Click the add button <DisplaiIcon name="add" /> in the “Inputs” section below “URL Template”.
...
7. Click the “Close” button <DisplaiIcon name="close" /> at the top right of the input.

## 4. Add a Units Input

Now that we’ve added the location input let’s add a units input to allow users to swap between Fahrenheit and Celsius.

1. Click the add button <DisplaiIcon name="add" /> in the “Inputs” section.
...
5. Click the add options button <DisplaiIcon name="add" /> next to the “Options” section.
6. Add an option with label “Fahrenheit” and value `fahrenheit`.
7. Click “Set Default”.
8. Click the add options button <DisplaiIcon name="add" /> again next to the “Options” section.
9. Add an option with label “Celsius” and value `celsius`.
10. Click the “Close” button <DisplaiIcon name="close" /> at the top right of the input.

## 5. Save & Preview

Now we’re ready to preview your Weather app in the Displai Dashboard.

1. Click “Save” to create your new Weather app.
2. Go to your Library in the [Displai Dashboard](https://dash.displai.ai/library).
3. Click Weather” app to open the presentation builder.

Congrats, you just built a Displai app!

You can save new versions of your app in the Developer Portal and any changes will show up in the Displai Dashboard’s presentation builder after you refresh the page.
...
3. Click this below “Deploy" button to deploy the Weather app to your own Vercel account.
   ...
   <a href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmirainc%2Fsimple-weather-app&env=OPENWEATHERMAP_API_KEY&envDescription=OpenWeather%20API%20key&envLink=https%3A%2F%2Fhome.openweathermap.org%2F&redirect-url=https%3A%2F%2Fdevelopers.displai.ai%2Fdocs%2Fget-started%2Fbuild-an-app">
...
- [Learn how Displai apps work when running in a playlist](/docs/core-concepts/app-lifecycle)
