...
Since Raydiant apps are just URLs, you can get pretty far in the development process without actually touching the Raydiant platform. To test any [inputs](/docs/core-concepts/inputs) your app requires, update the URL of the browser.
